...
def player_choice(enemy_health):
...
You hit their Carrier!")
        ...
        hit(player_choice_y - 1, player_choice_x - 1)
        
    elif enemy_board[player_choice_y - 1][player_choice_x - 1] == "2":
        print("HIT! \n\
You hit their Battleship!")
        enemy_board[player_choice_y - 1][player_choice_x - 1] = "X"
        enemy_health = enemy_health - 1
        hit(player_choice_x - 1, player_choice_y - 1)
        
    elif enemy_board[player_choice_y - 1][player_choice_x - 1] == "3":
        print("HIT! \n\
You hit their Cruiser!")
    ...
    elif enemy_board[player_choice_y - 1][player_choice_x - 1] == "4":
        print("HIT! \n\
You hit their Submarine!")
    ...
    elif enemy_board[player_choice_y - 1][player_choice_x - 1] == "0":
        print("MISS! \n\
You hit nothing!")
        enemy_board[player_choice_y - 1][player_choice_x - 1] = "X"
        miss(player_choice_x - 1, player_choice_y - 1)
        
    elif enemy_board[player_choice_y - 1][player_choice_x - 1] == "X":
...
def enemy_choice(player_health):
    def miss(x_coord, y_coord):
        pencolor("white")
        penup()
        forward((50 * x_coord) - 50)
...
They hit your Carrier!")
    ...
    elif player_board[enemy_choice_y - 1][enemy_choice_x - 1] == "2":
        print("HIT! \n\
They hit your Battleship!")
    ...
    elif player_board[enemy_choice_y - 1][enemy_choice_x - 1] == "3":
        print("HIT! \n\
They hit your Cruiser!")
    ...
    elif player_board[enemy_choice_y - 1][enemy_choice_x - 1] == "4":
        print("HIT! \n\
They hit your Submarine!")
    ...
    elif player_board[enemy_choice_y - 1][enemy_choice_x - 1] == "0":
        print("MISS! \n\
You hit nothing!")
        time.sleep(2)
        os.system('cls')
    ...
    elif player_board[enemy_choice_y - 1][enemy_choice_x - 1] == "X":
        print("You already hit that location!")
        time.sleep(2)
        os.system('cls')
...
while player_health > 0 and enemy_health > 0:
    enemy_health = player_choice(enemy_health)
    time.sleep(3)
    print(" ")
    player_health = enemy_choice(player_health)
    print(enemy_health)
    print(player_health)
